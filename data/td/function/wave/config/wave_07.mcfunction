...
execute if score $wave_time td.wave_time matches 240 run function td:spawn/tank
execute if score $wave_time td.wave_time matches 245 run function td:spawn/basic
execute if score $wave_time td.wave_time matches 270 run function td:spawn/basic
execute if score $wave_time td.wave_time matches 295 run function td:spawn/basic
execute if score $wave_time td.wave_time matches 360 run function td:spawn/tank
