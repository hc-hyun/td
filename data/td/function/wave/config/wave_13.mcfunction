...
execute if score $wave_time td.wave_time matches 40 run function td:spawn/random {type:"basic"}
execute if score $wave_time td.wave_time matches 60 run function td:spawn/random {type:"basic"}
