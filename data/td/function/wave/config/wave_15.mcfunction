...
execute if score $wave_time td.wave_time matches 100 run function td:spawn/tank
...
execute if score $wave_time td.wave_time matches 180 run function td:spawn/tank
...
execute if score $wave_time td.wave_time matches 340 run function td:spawn/tank
execute if score $wave_time td.wave_time matches 350 run function td:spawn/basic
